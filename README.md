...
- [bitnami-labs/sealed-secrets](https://github.com/bitnami-labs/sealed-secrets) ([helm-v2.7.1](https://github.com/bitnami-labs/sealed-secrets/releases/tag/helm-v2.7.1), 1 week ago) - A Kubernetes controller and tool for one-way encrypted Secrets
- [jmederer/tf-plugin-mirror](https://github.com/jmederer/tf-plugin-mirror) ([latest](https://github.com/jmederer/tf-plugin-mirror/releases/tag/latest), 2 weeks ago) - TF Plugin Mirror (for Air-Gapped Terraform Use) 
