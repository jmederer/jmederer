...
- [kubernetes-sigs/descheduler](https://github.com/kubernetes-sigs/descheduler) ([descheduler-helm-chart-0.35.0](https://github.com/kubernetes-sigs/descheduler/releases/tag/descheduler-helm-chart-0.35.0), 2 weeks ago) - Descheduler for Kubernetes

#### 🔨 My recent Pull Requests

- [feat(token): automountServiceAccountToken set hard to true on deployment](https://github.com/kubernetes-sigs/descheduler/pull/1641) on [kubernetes-sigs/descheduler](https://github.com/kubernetes-sigs/descheduler) (1 year ago)
