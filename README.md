...
- [bitnami-labs/sealed-secrets](https://github.com/bitnami-labs/sealed-secrets) - A Kubernetes controller and tool for one-way encrypted Secrets (5 months ago)

#### 🔭 Latest releases I've contributed to

- [bitnami-labs/sealed-secrets](https://github.com/bitnami-labs/sealed-secrets) ([helm-v2.4.0](https://github.com/bitnami-labs/sealed-secrets/releases/tag/helm-v2.4.0), 5 days ago) - A Kubernetes controller and tool for one-way encrypted Secrets
